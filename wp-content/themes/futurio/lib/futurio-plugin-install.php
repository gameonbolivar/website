...
if ( ! class_exists( 'Futurio_Plugin_Install' ) ) :
	...
	class Futurio_Plugin_Install {
		...
		public function plugin_install_scripts( $hook_suffix ) {
			...
			wp_enqueue_style( 'futurio-admin', get_template_directory_uri() . '/css/admin/admin.css', array(), '1', 'all' );
		}
		...
		public static function install_plugin_button( $plugin_slug, $plugin_file, $plugin_name, $classes = array(), $activated = '', $activate = '', $install = '' ) {
			if ( current_user_can( 'install_plugins' ) && current_user_can( 'activate_plugins' ) ) {
				...
				<a href="https://wordpress.org/plugins/<?php echo esc_attr( $plugin_slug ); ?>" target="_blank"><?php esc_attr_e( 'Learn more', 'futurio' ); ?></a>
				<?php
			}
		}
