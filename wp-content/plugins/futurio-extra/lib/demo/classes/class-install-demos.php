...
class FWP_Install_Demos {
	...
	public function create_admin_page() {
      ...
      <p>
        <?php esc_html_e( 'Thank you for using our theme. You can import our demo sites or set up the website from scratch.', 'futurio' ) ?>
        <a href="<?php echo esc_url( admin_url( 'themes.php?page=futurio' ) ); ?>" class="button action-btn">
          <?php esc_html_e( 'Futurio Options', 'futurio' ) ?>
        </a>
      </p>
